      ...
      <button>
        ...
        >
          ...
          <g id="SVGRepo_iconCarrier">
            {" "}
            <path d="M7 3V0H9V3H7Z" fill="#ffffff"></path>{" "}
            <path d="M9 13V16H7V13H9Z" fill="#ffffff"></path>{" "}
            <path
              d="M11 8C11 9.65685 9.65685 11 8 11C6.34315 11 5 9.65685 5 8C5 6.34315 6.34315 5 8 5C9.65685 5 11 6.34315 11 8Z"
              fill="#ffffff"
            ></path>{" "}
            <path d="M0 9H3V7H0V9Z" fill="#ffffff"></path>{" "}
            <path d="M16 7H13V9H16V7Z" fill="#ffffff"></path>{" "}
            <path
